                            ...
                            <Card className="border mb-5 border-white bg-white rounded-4 shadow-none">
                                <CardBody className="p-4">
                                    <Row>
                                        ...
                                        <Col lg={12} sm={12} className='px-2 mt-4'>
                                            <div className="w-100 vstack p-2 rounded-2 form-box">
                                                <Label className="fs-13 form-label mb-0" for='exhibitTypeSelect'>Exhibit Type</Label>
                                                <Input type="select" name="select" id="exhibitTypeSelect" className="border-0 fs-14 px-0" style={{ color: '#303030', backgroundColor: 'transparent', outline: 'none'}}>
                                                    <option>Select Exhibit Type</option>
                                                    <option>FinTech Application</option>
                                                    <option>Big Data Application</option>
                                        ...
                                        <Col lg={12} sm={12} className='px-2 mt-4'>
                                            <div className="w-100 vstack p-2 rounded-2 form-box">
                                                ...
                                                <textarea rows={10} placeholder="Enter Proposed Partnership Benefits" className="border-0 fs-14"  style={{ color: '#303030', backgroundColor: 'transparent' }} />
                                            </div>
                                        </Col>
                                        <Col lg={12} sm={12} className='px-2 mt-4'>
                                            <div className="w-100 vstack p-2 rounded-2 form-box">
