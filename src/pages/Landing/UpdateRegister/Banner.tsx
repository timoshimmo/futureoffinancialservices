        ...
        <React.Fragment>
            <section className="section reg-banner">
                ...
                <Row className='w-100 justify-content-center'>
                    <Col lg={12}>
                        <h2 className="w-100 text-center fw-bold lh-base text-primary display-4 side-spacing" style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif' }}>FFS 2024, Roundtable Selection</h2>
                    </Col>
                    {/*
