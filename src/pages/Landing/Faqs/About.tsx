...
const About = () => {
    return (
        <React.Fragment>
            ...
            <section className="section body-bg-dark bottom-padding top-padding">
                <Container>
                    <Row className="justify-content-center">
                        <Col lg={7}>
                            <div className="text-center mb-5">
                                {/* <h2 className="fw-semibold lh-base text-primary" style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif' }}>About</h2> */}
                                <h2 className="w-100 text-center fw-bold lh-base text-primary display-4 px-5" style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif' }}>About</h2>
                            </div>
                        </Col>
                    </Row>
                    <Row className="align-items-center gy-4 mid-padding-top">
