...
const CTA = () => {
    ...
    return (
        <React.Fragment>
            <section className="py-5 mx-auto position-absolute bg-white border rounded-5 web-cta-insights">
                            ...
                            <Form
                                ...
                                className="needs-validation" action="#"> 
                                    ...
                                    <Input
                                        ...
                                        className="border-0 fs-13 px-3 w-100"  
                                        type="email"
                                ...
                                <div className="mt-3 d-flex justify-content-center">
                                    ...
                                    <button className="btn btn-primary border border-primary rounded-5 py-2 fs-14" type="submit" disabled={loading? true : false} style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif' }}>
