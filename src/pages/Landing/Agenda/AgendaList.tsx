                    ...
                    <Row className='justify-content-between'>
                        <Col lg={4} sm={12} className='position-sticky'>
                            ...
                            <div className='border p-4 border-white rounded-3'>
                                ...
                                <h2 className='my-4 text-primary fs-20' style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif' }}>Session Types</h2>
                                <Nav pills className="nav-pills filter-btns gap-2" role="tablist">
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">All</NavLink>
                                    </NavItem>
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">Keynote Presentation</NavLink>
                                    </NavItem>
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">Panel Session</NavLink>
                                    </NavItem>
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">Fireside Chat</NavLink>
                                    </NavItem>
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">Product Demo</NavLink>
                                    </NavItem>
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">Workshops</NavLink>
                                    </NavItem>
                                    <NavItem role="presentation">
                                        <NavLink type="button" className="fw-medium fs-12 border border-white rounded-2">Roundtable</NavLink>
                                    </NavItem>
                                </Nav>
                            </div>
                        </Col>
