                                ...
                                <CardBody className="p-4">
                                    <Row className='justify-content-center'>
                                        <Col lg={9} sm={12} className='px-2 mt-4'>
                                            <h2 className='text-primary mb-3 text-center fw-bold' style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif' }}>Thank You For Registering</h2>
                                            <p className='text-dark fs-14 text-center fw-medium mb-0' style={{ color: '#303030' }}>Your have Successfully secured a spot to our event.</p>
                                            <p className='text-dark fs-14 text-center fw-medium mb-4' style={{ color: '#303030' }}>We'll keep in touch with you via email for more info and updates.</p>
